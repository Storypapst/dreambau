...
const messages = {
  de: {
    ...
    "presets.loading": "Presets werden geladen …",
    "presets.empty": "Noch keine Presets. Filter setzen und speichern, dann reicht später ein Klick.",
    "presets.saveCurrent": "Aktuellen Filter speichern",
    "presets.needFilters": "Erst einen Filter setzen",
    "presets.nameLabel": "Name des Presets",
    "presets.namePlaceholder": "z. B. ORISO Berater aktiv",
    "presets.save": "Speichern",
    "presets.cancel": "Abbrechen",
    "presets.delete": "Preset löschen",
    "presets.error": "Presets konnten nicht gespeichert werden.",
  ...
  en: {
    ...
    "presets.empty": "No presets yet. Set filters and save them, then one click brings them back.",
    "presets.saveCurrent": "Save current filters",
    "presets.needFilters": "Set a filter first",
    "presets.nameLabel": "Preset name",
    "presets.namePlaceholder": "e.g. ORISO consultants active",
    "presets.save": "Save",
    "presets.cancel": "Cancel",
    "presets.delete": "Delete preset",
    "presets.error": "Presets could not be saved.",
