...
- [x] Add a NetworkPolicy, PodDisruptionBudget and resource requests/limits. Egress is restricted to DNS and MinIO — the gateway holds no GitHub token and never calls the public internet.
