...
Die Anwendung läuft als Einzelreplica `wcr/testmails`. Der Quellstand liegt auf dem Server unter `/root/testmails-app`; das Image heißt `dreambau-testmails:0.1.0`.
