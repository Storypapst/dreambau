...
Die Anwendung läuft als Einzelreplica `wcr/testmails`. Der Quellstand liegt auf dem Server unter `/root/testmails-app`; das aktuelle Image heißt `dreambau-testmails:0.2.3`.
